...
- **Other available models** (Sonnet, Haiku) remain options when task shape, context already in hand, account access or an explicit user choice favours them. Cross-provider delegation is not an obligation.
